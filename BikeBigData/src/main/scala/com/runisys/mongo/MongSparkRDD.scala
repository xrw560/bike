...
object MongSparkRDD {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val conf = new SparkConf()
      ...
      .setMaster("local[*]")
      .set("spark.mongodb.input.uri", "mongodb://xiaoniu:123456@192.168.170.181:27017/xiaoniu.logs")
      .set("spark.mongodb.output.uri", "mongodb://xiaoniu:123456@192.168.170.181:27017/xiaoniu.result")
    ...
    val uv = docsRDD.map(doc =>{doc.getString("openid")}).distinct().count()
    //    val pv = docsRDD.count()
    //
